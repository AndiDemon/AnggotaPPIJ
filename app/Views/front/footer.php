<!-- Footer Start -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        <a href="#" class="logo-footer">
                            <img src="<?php echo base_url('templates/landrick/images/logo-light.png')?>" height="24" alt="">
                        </a>
        ...
        <!-- javascript -->
        <script src="<?php echo base_url('templates/landrick/js/jquery-3.5.1.min.js')?>"></script>
        <script src="<?php echo base_url('templates/landrick/js/bootstrap.bundle.min.js')?>"></script>
        <script src="<?php echo base_url('templates/landrick/js/jquery.easing.min.js')?>"></script>
        <script src="<?php echo base_url('templates/landrick/js/scrollspy.min.js')?>"></script>
        <!-- Magnific Popup -->
        <script src="<?php echo base_url('templates/landrick/js/jquery.magnific-popup.min.js')?>"></script> 
        <script src="<?php echo base_url('templates/landrick/js/magnific.init.js')?>"></script>
        <!-- Icons -->
        <script src="<?php echo base_url('templates/landrick/js/feather.min.js')?>"></script>
