                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-title">
                                    ...
                                    <?php }
                                    ?>
                                    <form action="<?= base_url('itemcategory/save');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="category" placeholder="Input new category name" class="form-control" required="required" value="">
                                            </div>
                                        </div>
